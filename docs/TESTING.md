...
| 14 | Installation und Deinstallation | `installer/test-install.ps1` in CI: stille Installation, Dateien, Verknüpfungen, Autostart, Native-Messaging-Registrierung, Start der App (`--selftest`), Deinstallation mit Behalten der Daten, Neuinstallation, Deinstallation mit sicherem Löschen der Daten |
